...
int main(int argc, char *argv[]) {
  try {
    argparse::ArgumentParser program("gen-normal");

    program.add_description(
        "A utility to generate normally distributed floating-point numbers.\n"
        "Outputs standard normal distributed numbers to standard output.");
